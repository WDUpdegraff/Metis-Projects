# This does a few things to clean up the data
...
# Maps ratings to ascending integers, G is 0, PG is 1, etc.
...
# Manual consumer price index for inflation adjustment
...
# Text parsing to transform to numerical
